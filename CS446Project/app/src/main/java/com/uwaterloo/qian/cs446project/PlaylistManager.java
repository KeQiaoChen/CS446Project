...
/**
 * Class com.uwaterloo.qian.cs446project.PlaylistManager manages playlist
 */
...
public class PlaylistManager {
    ...
    // listAllDeviceSongs searches the device for all audio files and generates an ArrayList<com.uwaterloo.qian.cs446project.Song> object for all
    // the songs to return.
    public static ArrayList<Song> listAllDeviceSongs(Context ctx) {
        ...
        // Iterate over non-null Cursor object and create ArrayList<com.uwaterloo.qian.cs446project.Song> object.
    ...
    // ArrayList<com.uwaterloo.qian.cs446project.Playlist> object containing the playlist data, and returns said object. Note that the returned
    // com.uwaterloo.qian.cs446project.Playlist objects do not have their songs attribute populated. Please call
    // com.uwaterloo.qian.cs446project.PlaylistManager.listAllPlaylistSongs to populate the songs attribute.
    public static ArrayList<Playlist> listAllAppPlaylists(Context ctx) {
        ...
        // Iterate over non-null Cursor object and create ArrayList<com.uwaterloo.qian.cs446project.Playlist> object.
    ...
    // listAllPlaylistSongs queries for all the songs under the given playlist, updates the given com.uwaterloo.qian.cs446project.Playlist
    // object's songs variable with the queried song data, and returns the com.uwaterloo.qian.cs446project.Playlist object's updated songs
    // variable.
    public static LinkedList<Song> listAllPlaylistSongs(Context ctx, Playlist pl) {
        ...
        // Iterate over non-null Cursor object and create LinkedList<com.uwaterloo.qian.cs446project.Song> object.
    ...
    // createPlaylist creates a new playlist on the device with the given name and returns a com.uwaterloo.qian.cs446project.Playlist object
    ...
    // deletePlaylist deletes the given playlist from the device and nullifies the given com.uwaterloo.qian.cs446project.Playlist object. The
    ...
    // addSongToPlaylist updates the device's playlist with the provided song and updates the given com.uwaterloo.qian.cs446project.Playlist
    ...
    public static Boolean addSongToPlaylist(Context ctx, Playlist pl, Song s) {
        ...
        if (previousPlaylistSongCount != currentPlaylistSongCount - 1) {
            Log.e("Playlist Manager", "com.uwaterloo.qian.cs446project.Song " + s.getTitle() + " with ID " + s.getLocalDeviceFileID() + "could not be added to playlist " + pl.getPlaylistName() + " with ID " + pl.getPlaylistID());
    ...
    // from the provided com.uwaterloo.qian.cs446project.Playlist object as well. The returned Boolean value indicates a success (true) or failure
    // (false).
